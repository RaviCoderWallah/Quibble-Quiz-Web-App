  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-4xl">
      <div className="bg-[#201f1f] p-4 rounded-md flex flex-col gap-6 py-6 outline-1 outline-gray-700 md:order-1 order-2">
        ...
        <p className="text-center text-gray-300">Already have a account? <NavLink to="/login" className="text-yellow-500 font-semibold underline">Log In</NavLink></p>
      </div>
      <div className="md:order-2 order-1">
        <img src={SignupScreenImage} alt="People with share its quiz game play." className="rounded-md" />
      </div>
    </div>
  )
}
