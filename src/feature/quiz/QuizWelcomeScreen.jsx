...
const QuizWelcomeScreen = ({ setIsWelcomeScreenShow }) => {
  ...
  const { activeSubCategory, changeDifficulty } = useQuiz();

  const handleDifficultyLevel = (e) => {
    setSelectedDifficultyValue(e.target.value);
        ...
        <div className="space-y-2 text-sm sm:text-base">
          ...
          <div className="flex gap-3">
            ...
            <p className="text-sm">
              ...
              <span className="text-white font-mono mx-1">+5</span>, Medium{" "}
              <span className="text-white font-mono mx-1">+10</span>, Hard{" "}
              <span className="text-white font-mono mx-1">+20</span>.
            </p>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <p className="text-sm">
              <span className="text-red-400 font-semibold">Skip Penalty:</span>{" "}
              Skipping a question costs{" "}
              <span className="text-red-400 font-mono">10 points</span>.
            </p>
          </div>
        </div>
      </div>
